...
export var points = {
  "WHG":{
    "2F": {
      ...
      3: { name: "节点3", position: [-66.953, 0, -20.58] },
      ...
      11: { name: "节点11", position: [10.54, 0.6, -96.032] },
      12: { name: "节点12", position: [10.54, 0.6, -83.165] },
      ...
      22: { name: "节点22", position: [26.54, 0.6, -86.165] },
      23: { name: "节点23", position: [56.54, 0.6, -87.165] },
      24: { name: "活动楼梯节点24", position: [17.819, 0.6, -23.426] },
    },
    "B1":{
      0:{name:"节点0",position:[23.700,0.6,-22.295]},
      1:{name:"节点1",position:[23.751,0.6,-33.612]},
      2:{name:"节点2",position:[16.642,0.6,-33.612]},
      3:{name:"节点3",position:[23.751,0.6,-45.612]},
      4:{name:"节点4",position:[31.751,0.6,-45.612]},
      5:{name:"节点5",position:[80.189,0.6,-40.618]},
      6:{name:"节点6",position:[90.925,0.6,-58.061]},
      7:{name:"节点7",position:[33.751,0.6,-68.612]},
      8:{name:"节点8",position:[28.751,0.6,-68.612]},
      9:{name:"节点9",position:[32.751,0.6,-99.612]},
      10:{name:"节点10",position:[33.751,0.6,-105.612]},
      11:{name:"节点11",position:[29.751,0.6,-105.612]},
      12:{name:"节点12",position:[-128.894,0.6,-79.903]},
      24:{name:"节点24",position:[23.751,0.6,-40.612]},
      25:{name:"节点25",position:[30.751,0.6,-39.612]},
      26:{name:"节点26",position:[31.751,0.6,-58.612]},
      27:{name:"节点27",position:[-12.751,0.6,-52.612]},
      28:{name:"节点28",position:[-12.152,0.6,-79.408]},
      13:{name:"节点13",position:[90.925,0.6,-86.061]},
      14:{name:"节点14",position:[31.751,0.6,-86.612]},
...
function getLength(src, des) {
  ...
  return Math.sqrt(
    (srcPosition[0] - desPosition[0]) * (srcPosition[0] - desPosition[0]) +
      (srcPosition[1] - desPosition[1]) * (srcPosition[1] - desPosition[1]) +
      (srcPosition[2] - desPosition[2]) * (srcPosition[2] - desPosition[2])
  );
}
/**
 * 节点的数量
...
function addRouteLine() {
  ...
  for (var key in routes) {
    ...
    var src = points[route.src],
      des = points[route.des];
    var srcPosition = new THREE.Vector3(
      src.position[0],
      src.position[1],
      src.position[2]
    );
    var desPosition = new THREE.Vector3(
      des.position[0],
      des.position[1],
      des.position[2]
    );
